"""
train_final_no_early_stop.py
============================
After the RL agent finds the best hyperparameters, this module trains a
PyTorch model for the full FINAL_EPOCHS without early stopping.
...
OUTPUT_DIR = "output_without_early"
...
def run(best_params, x_train, y_train, x_test, y_test, vocab_size,
        epochs=FINAL_EPOCHS):
    """
    Train a PyTorch model for exactly `epochs` epochs mapping best params.
    ...
    print("\n" + "=" * 60)
    print("  FINAL TRAINING (PyTorch)  —  Full 50 Epochs (No Early Stop)")
    print("=" * 60)
    ...
    for epoch in range(1, epochs + 1):
        ...
        # --- Best Model check (No Early Stopping, just saving weights) ---
    ...
    if best_model_state is not None:
        ...
        print("\n[EVAL] Best model weights restored from overall best checkpoint.")
